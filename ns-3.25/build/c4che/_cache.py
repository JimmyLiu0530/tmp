...
EXAMPLE_DIRECTORIES = ['routing', 'realtime', 'udp-client-server', 'wireless', 'energy', 'matrix-topology', 'error-model', 'stats', 'socket', 'udp', 'tutorial', 'traffic-control', 'ipv6', 'tcp', 'naming']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/hsnl/repos_test/ns-3-allinone/ns-3.25/build']
...
cfg_files = ['/home/hsnl/repos_test/ns-3-allinone/ns-3.25/build/ns3/config-store-config.h', '/home/hsnl/repos_test/ns-3-allinone/ns-3.25/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
